...
if [[ $appName = "" ]]; then
    ...
    cd ..
    mv brpc-template $appName-service
    cd $appName-service

    sed -i "" "s/$templateName/$appName/g" *.xml

    mv dao/src/main/java/com/mornsnow/$templateName/ dao/src/main/java/com/mornsnow/$appName/
    mv service/src/main/java/com/mornsnow/$templateName/ service/src/main/java/com/mornsnow/$appName/

    sed -i "" "s/$templateName/$appName/g" dao/src/main/java/com/mornsnow/$appName/dataobject/*.java
    ...
    sed -i "" "s/$templateName/$appName/g" dao/src/main/java/com/mornsnow/$appName/dao/datasource1/*.java
    sed -i "" "s/$templateName/$appName/g" dao/src/main/java/com/mornsnow/$appName/dao/datasource2/*.java
    sed -i "" "s/$templateName/$appName/g" dao/src/main/java/com/mornsnow/$appName/dao/*.java
    sed -i "" "s/$templateName/$appName/g" service/src/main/java/com/mornsnow/$appName/*/*.java
    sed -i "" "s/$templateName/$appName/g" service/src/main/java/com/mornsnow/application/Application.java

    sed -i "" "s/$templateName/$appName/g" service/src/main/resources/application.properties
    sed -i "" "s/com.mornsnow.template.dao/com.mornsnow.$appName.dao/g" service/src/main/java/com/mornsnow/$appName/api/DemoController.java
...
if [[ $datasource = "Y" ]]; then
    ...
    rm -rf dao/src/main/java/com/mornsnow/$appName/dao/*.java
    ...
    rm -rf dao/src/main/java/com/mornsnow/$appName/dao/datasource1/
    rm -rf dao/src/main/java/com/mornsnow/$appName/dao/datasource2/
